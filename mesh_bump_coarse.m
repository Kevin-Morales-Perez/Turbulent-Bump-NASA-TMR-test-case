...
if (distPlat+ bumpLgt)<domLgt
    ...
    nx=50;% number of cells in x axis 
    ny=30;% number of cells in y axis
    ncells=nx*ny; %Total cells

    est_wall_d=35e-3;%4.1750e-04;%Estimated wall distance (Height of the first cell 8.5e-6 for y+=1)
    %
    ...
    dx_1=0.05;%Lenght of the first cell at the leading and trailing edge 0.006
    grthFx=1.1;% Geometrical growth  Factor
    ...
    yBump=0.01*sin(pi*xBump/0.9 -(pi/kBump)).^4; %Y coordinates for bump*
