...
%                                                      M  
%                                                      A 
%    ___ NEUMANN ___|___   0    ___|___ NEUMMAN  ____ N
    ...
    %NEUMMAN AT FREE STREAM 0 AT SOLID SURFACE
    i=ny;
    for j=2:nx-1
        ...
        if solidMask(j)% solid surf.
            ...
            Ant_P(i,j)=Ant_W(i,j) + Ant_N(i,j) + Ant_E(i,j) ...
                +fW +fN +fE+ fS - cellVols(i,j)*q_s_prime;
    ...
    Ant_P(i,j)=Ant_W(i,j) + Ant_N(i,j)   +fW +fN +fE +fS - ...
        cellVols(i,j)*q_s_prime;
