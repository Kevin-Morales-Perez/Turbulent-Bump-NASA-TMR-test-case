...
if (distPlat+ bumpLgt)<domLgt
    ...
    ny=55;% number of cells in y axis
    ncells=nx*ny; %Total cells

    est_wall_d=1.02e-6;%6.8e-5;%4.1750e-04;%Estimated wall distance 
    ...
    %  domain length
    fpRatio = 0.59;%bumpLgt/domLgt;% Now the plate should contain half o f the 
    %total cells in X
