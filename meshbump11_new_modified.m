...
if (distPlat+ bumpLgt)<domLgt
    ...
    nx=150;% number of cells in x axis 
    ny=40;% number of cells in y axis
    ncells=nx*ny; %Total cells

    est_wall_d=6.8e-5;%6.8e-5;%4.1750e-04;%Estimated wall distance 
    ...
    %  domain length
    fpRatio = 0.665;%bumpLgt/domLgt;% Now the plate should contain half o f the 
    %total cells in X
