...
if (distPlat+ bumpLgt)<domLgt
    ...
    est_wall_d=4e-4;%6.8e-5;%4.1750e-04;%Estimated wall distance 
    ...
    %  domain length
    fpRatio = 0.5600;%bumpLgt/domLgt;% Now the plate should contain half o f the 
    %total cells in X
    ...
    %m_new=zeros(1,ny);
    m_new=linspace(8.3e-2,0.0021,ny);
    %UPWIND ZONE
    for j=nx_upstr:-1:1
