...
if (distPlat+ bumpLgt)<domLgt
    ...
    nx=170;% number of cells in x axis 
    ny=50;% number of cells in y axis
    ncells=nx*ny; %Total cells

    est_wall_d=1.0200e-6;%6.8e-5;%4.1750e-04;%Estimated wall distance 
    ...
    %  domain length
    fpRatio = 0.53;%bumpLgt/domLgt;% Now the plate should contain half o f the 
    %total cells in X
    ...
    grthF=1.4;% Geometrical growth  Factor ,1.3
