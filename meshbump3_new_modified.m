...
if (distPlat+ bumpLgt)<domLgt
    ...
    est_wall_d=6.8e-5;%4.1750e-04;%Estimated wall distance 
    ...
    %  domain length
    fpRatio = 0.56;%bumpLgt/domLgt;% Now the plate should contain half o f the 
    %total cells in X
    ...
    %m_new=zeros(1,ny);
    m_new=linspace(0.9e-2,2.2857e-04,ny);
    %UPWIND ZONE
    for j=nx_upstr:-1:1
